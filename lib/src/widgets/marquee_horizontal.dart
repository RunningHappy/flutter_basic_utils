...
/// 跑马灯(横向)
///
class MarqueeHorizontal extends StatefulWidget {
  ...
  const MarqueeHorizontal(
      {Key? key, this.paddingLeft, this.duration, this.stepOffset, this.children}) : super(key: key);

  @override
  _MarqueeHorizontalState createState() => _MarqueeHorizontalState();
}

class _MarqueeHorizontalState extends State<MarqueeHorizontal> {
