...
CommonSearchBar(
  ...
  bool? showCancle = false, //是否显示取消按钮
  Function()? clickCancle, //点击取消按钮回调
  String? iconPath, //输入框左侧图片路径
  String? rightIconPath,//右侧按钮图片路径
  String? cancleText, //取消按钮文字
  double? cancleTextSize, //取消按钮文字大小
  }){
  ...
  return AppBar(
    ...
    title: showRightBtn! ? Row(
      children: [
        ...
        rightIconPath != null ? Row(
          children: [
            SizedBox(width: 16.w,),
            Image.asset(rightIconPath,width: 36.h,height: 36.h,)
          ],
        ) : Container()
      ],
    ) : Row(
