...
/// 选中扇形区域后执行的回调
typedef DoughnutSelectCallback = void Function(
...
class Doughnut extends CustomPainter {
  ...
  /// 选中区域回调
  final DoughnutSelectCallback? doughnutSelectCallback;
  ...
  Doughnut(
      {this.ringWidth = 50,
        ...
        this.doughnutSelectCallback}) {
    double lastEndRadius = 0;
    double totalValue = 0;
    this.data.forEach((DoughnutDataItem item) {
  ...
  bool? hitTest(Offset position) {
    ...
    for (int i = 0; i < length; i++) {
      ...
      if (item.startRadius < radain &&
        ...
        if (null != doughnutSelectCallback)
          doughnutSelectCallback!(
    ...
    return Padding(
      ...
      child: CustomPaint(
        ...
        foregroundPainter: Doughnut(
            ...
            doughnutSelectCallback: this.selectCallback),
      ),
    );
  }
}
