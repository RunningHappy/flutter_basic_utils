...
class DoughnutChartLegend extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (DoughnutChartLegendStyle.list == this.legendStyle) {
      List<Widget> items = [];
    ...
    } else if (DoughnutChartLegendStyle.wrap == this.legendStyle) {
      List<Widget> items = [];
      this.data.forEach((DoughnutDataItem item) {
        items.add(this.genItem(item));
      });
  ...
  Widget genItem(DoughnutDataItem item) {
    return Row(
